...
gap=0
thits=0
TargetedL=0#no of cases when the chart was initially in favor, but later hit SL at a loss
...
print("Targeted Loss",TargetedL)
print("Absolute Loss",Ltrade-TargetedL)
