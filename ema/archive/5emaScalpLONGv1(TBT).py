...
for i in range(0,len(datetime_objects)):
    ...
    if position=="Long":
        ...
        if (low_values[i]<=stoploss):
            ...
            plot_times.clear()
            if print_processs:
                print(datetime_strings[i],"SLHIT Long exit at",stoploss,"with",close_values[i]-entry,"points")
            net+=stoploss-entry
            ...
            plot_times.clear()
            if print_processs:
                print(datetime_strings[i],"TARGETHIT Long exit at",target,"with",close_values[i]-entry,"points")
            net+=target-entry
