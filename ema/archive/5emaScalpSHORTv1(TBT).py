...
for i in range(0,len(datetime_objects)):
    ...
    #         plot_times.clear()
    #         if print_processs:
    #             print(datetime_strings[i],"Long exit at",target,"with",close_values[i]-entry,"points")
    #         net+=target-entry
    ...
    if position=="Short":
        ...
        if (high_values[i]>=stoploss and position=="Short"):
            position="Empty"
            plot_bar.append(close_values[i])
            plot_times.append(datetime_objects[i])
            ...
            plot_times.clear()
            if print_processs:
                print(datetime_strings[i],"SLHIT Short exit at",stoploss,"with",-stoploss+entry,"points")
            net+=-stoploss+entry            
            ...
            plot_times.clear()
            if print_processs:
                print(datetime_strings[i],"TARGETHIT Short exit at",target,"with",-target+entry,"points")
            net+=-target+entry
    ...
    # if datetime_objects[i].min==14 or datetime_objects[i].min==29 or datetime_objects[i].min==44 or datetime_objects[i].min==59:
    if bar15==14:
        seek_status="Empty"
