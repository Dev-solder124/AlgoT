...
#plt.plot(datetime_objects, open_values,color='brown', linestyle='-')
    ...
    if bar15==15:
        ...
        if position=="Empty":
            if curr15_low>max15_ema:
                ...
                if print_processs:
                    print(datetime_strings[i],seek_status,curr15_low,max15_ema)
